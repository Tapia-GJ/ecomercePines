        ...
        <div className="mt-10">
          <div className="flex flex-wrap justify-center gap-6">
            {[
              ...
              { name: "Llavero Pareja", price: 40, img: "/product/4l.jpg" },
              {
                name: "Pin Gnomo Gravity Falls",
                price: 45,
                img: "/product/5.jpg",
              },
              { name: "Llavero Gatitos", price: 30, img: "/product/6l.jpg" },
              { name: "Pin Michi Fresas", price: 35, img: "/product/7.jpg" },
              { name: "Pin Abeja Minecraft", price: 20, img: "/product/8.jpg" },
            ].map((product, index) => (
              <div
                key={index}
